...
Исходная идея уже задаёт правильную TCP-модель: одна логическая сессия должна использовать несколько отдельных TCP-соединений на разные IP одновременно.
