...
- следующей открытой фазой остаётся уже не локальная IPv4/IPv6 валидация, а отдельная public/external multi-IP validation на внешнем хосте вне этой пары локальных Linux VM.
